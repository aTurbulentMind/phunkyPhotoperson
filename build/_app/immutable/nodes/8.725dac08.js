import{s as f,n as a}from"../chunks/scheduler.c352f365.js";import{S as g,i as v,g as d,s as m,h as u,A as h,c as b,k as x,a as o,f as r}from"../chunks/index.e8215bcd.js";function y(p){let e,c="Training",n,i,l=`<p class="text_Box cut_Box">Debt$Net® offers several training packages to meet the diverse needs of our clients. We provide
		...
		costs.</p> <p class="text_Box cut_Box">One-Day New User Training: This training package is tailored to new users of Debt$Net® and
		...
		answered.</p> <p class="text_Box cut_Box">Phone Sessions: One-on-one training sessions on specific topics can be scheduled on an as-needed
		...
		Extended Service Option (ESO).</p> <p class="text_Box cut_Box">Individual Training: Debt$Net® can develop a course specifically tailored for your needs and
		...
		only those topics of interest to the client. A minimum of eight hours of training is required.</p> <p class="text_Box cut_Box">On-Site Training: Debt$Net® can also provide a customized course for presentation at your site.
		...
		length, and includes actual travel, per diem, and equipment setup costs.</p>`;return{c(){e=d("h1"),e.textContent=c,n=m(),i=d("div"),i.innerHTML=l,this.h()},l(t){e=u(t,"H1",{"data-svelte-h":!0}),h(e)!=="svelte-y9welu"&&(e.textContent=c),n=b(t),i=u(t,"DIV",{class:!0,"data-svelte-h":!0}),h(i)!=="svelte-1dooqix"&&(i.innerHTML=l),this.h()},h(){x(i,"class","text_Block")},m(t,s){o(t,e,s),o(t,n,s),o(t,i,s)},p:a,i:a,o:a,d(t){t&&(r(e),r(n),r(i))}}}class _ extends g{constructor(e){super(),v(this,e,null,y,f,{})}}export{_ as component};
